...
class ColorResources {
  static  Color getPrimaryColor() {
    return true? const Color(0xFF002931) : const Color(0xFF003E47);
  }
  static  Color getPrimaryTextColor() {
    return true? const Color(0xFF8dbac3) : const Color(0xFF003E47);
  }
  static Color getSecondaryHeaderColor() {
    return true? const Color(0xFFaaa818) : const Color(0xFFCFEC7E);
  }
  static Color getGreyColor() {
    return true? const Color(0xFF6f7275) : const Color(0xFFA0A4A8);
  }
  static Color getGreyBaseGray1() {
    return true? const Color(0xFFd3d3d8) : const Color(0xFF8E8E93);
  }
  static Color getLightGray() {
    return true? const Color(0x00dbdbdb) : const Color(0xFFF3F3F3);
  }
  static Color getAcceptBtn() {
    return true? const Color(0xFF065802) : const Color(0xFF95CD41);
  }

  static Color getGreyBaseGray3() {
    return true? const Color(0xFF757575) : const Color(0xFFC7C7CC);
    
  }
  static Color getGreyBaseGray4() {
    return true? const Color(0xFFe3e3e8) : const Color(0xFFD1D1D6);
    
  }
  static Color getGreyBaseGray6() {
    return true ? const Color(0xFFb2b5c8) : const Color(0xFFF2F2F7);
  }
 
  static Color getSearchBg() {
    return true ? const Color(0xFF585a5c) : const Color(0xFFF4F7FC);
  }
  static Color getBackgroundColor() {
    return true ? const Color(0xFF343636) : const Color(0xFFFAFAFA);
  }
  static Color getBlackAndWhite() {
    return true ? const Color(0xFFFFFFFF) : const Color(0xFF606060);
  }
  static Color getWhiteAndBlack() {
    return true ? const Color(0xFF000000) : const Color(0xFFFFFFFF);
  }
  static Color getLightAndDark(BuildContext context) {
    return true ? Theme.of(context).cardColor : const Color(0xFF000000) ;
  }
  static Color getOccupationCardColor() {
    return true ? const Color(0xFF3c3c3c) : const Color(0xFFFFFFFF);
  }
  static Color getHintColor() {
    return true ? const Color(0xFF98a1ab) : const Color(0xFF808080);
  }
  static Color getGreyBunkerColor() {
    return true ? const Color(0xFFE4E8EC) : const Color(0xFF25282B);
  }
  ...
  static Color getAcceptTextColor() {
    return true ?  const Color(0xFF25282B): const Color(0xFFE4E8EC);
  }
  static Color getNoteTextColor() {
    return true ?  const Color(0xFF25282B): const Color(0xFF14684E);
  }


  
   static Color getTransactionTitleColor() {
    return true ? const Color(0xFF71a8c1) : const Color(0xFF174061);
  }
   static Color getTransactionTrilingColor() {
    return true ? const Color(0xFF84b1cc) : const Color(0xFF344968);
  }
  static Color getWebsiteTextColor() {
    return true ? const Color(0xFF84b1cc) : const Color(0xFF344968);
  }
  static Color getBalanceTextColor() {
    return true ? const Color(0xFFd7d7d7) : const Color(0xFF393939);
  }
  static Color getShadoColor() {
    return true ? const Color(0xFFededed) : const Color(0xFF848484);
  }
  //card.
   static Color getAddMoneyCardColor() {
    return true ? const Color(0xFF398343) : const Color(0xFFACD9B3);
  }
   static Color getCashOutCardColor() {
    return true ? const Color(0xFFf57a00) : const Color(0xFFFFCB66);
  }
   static Color getRequestMoneyCardColor() {
    return true ? const Color(0xFFa900a0) : const Color(0xFFF6BDE9);
  }
   static Color getReferFriendCardColor() {
    return true ? const Color(0xFF0083cf) : const Color(0xFFADE4FD);
  }
   static Color getOthersCardColor() {
    return true ? const Color(0xFF3137c9) : const Color(0xFFD0C5FF);
   }
   static Color getShadowColor() {
    return true ? const Color(0xFFeeeeee) : const Color(0xFF757575);
  }
  //onboarding
   static Color getOnboardingBgColor() {
    return true ? const Color(0xFF4a5361) : const Color(0xFFD1D5DB);
  }
  static Color getOnboardGreyColor() {
    return true ? const Color(0xFFe9e8f5) : const Color(0xFF6D6D78);
  }
  static Color getDividerColor() {
    return true ? const Color(0xFFd9d9d9) : const Color(0xFF434343);
  }

  static Color getSupportScreenTextColor() {
    return true ? const Color(0xFFe6e6e6) : const Color(0xFF484848);
  }
  static Color getLightGrey() {
    return true ? const Color(0xFF686868) : const Color(0xFFF8F8F8);
  }
  static Color getOtpFieldColor() {
    return true ? const Color(0xFF6a6e81) : const Color(0xFFF2F2F7);
  }
  ///#686868
